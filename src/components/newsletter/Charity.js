  ...
  return (
    <section>
      <Container className="section">
        <Row>
          <h1 className="title">
            <span>Charity</span> Work
          </h1>
        </Row>
        <Row className="char-box-row">
          <div className="char-box box1">
            <img src={pic2016} alt="" />
            <h2>Charity Day 2016</h2>
            <p>
              The event took place on February 14th which in fact coincides with
              Valentine’s Day,
            </p>
            <p>
              the international day of sharing and making people feel important
              and special.
            </p>
            <p>
            ...
            <p>
              a variety of workshops such as; the DIY (do-it-yourself) workshop.
            </p>
            <p>
          ...
          <div className="char-box box2">
            ...
            <p>
              is preparing a very varied and interesting program for this year.
            </p>
          ...
          <div className="char-box box3">
            ...
            <p>
              and putting a smile on their faces by doing a bunch of activities
              such as plays
            </p>
